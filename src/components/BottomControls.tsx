        ...
        <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-[1000] bg-white/75 backdrop-blur-md border border-white/40 p-3 rounded-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.1)] flex flex-col items-center gap-3 font-sans w-[95%] sm:w-max" style={{ fontSize: '0.85rem' }}>
            <div className="flex items-center gap-4 flex-wrap justify-center">
                <form onSubmit={handleUsernameSubmit} className="flex items-center gap-2">
                    ...
                    />
                    <button type="submit" className="btn btn-sm btn-primary border-none text-white font-medium cursor-pointer select-none" style={{ height: '32px', borderRadius: '10px', fontSize: '0.8rem', backgroundColor: '#4F46E5' }}>Fetch</button>
                </form>
                    ...
                    {(viewMode === '3d' || viewMode === 'yearly') && (
                        <label className="cursor-pointer select-none flex items-center gap-1.5 text-[#4B5563] font-medium">
                            <input
                                ...
                                className={`checkbox checkbox-sm rounded border-[#D1D5DB] ${userPhysicsEnabled ? 'checkbox-primary' : 'bg-white'}`}
                            />
                            Physics
                        </label>
                    )}
            ...
            <div className="flex items-center gap-4 flex-wrap justify-center">
                <div className="flex items-center gap-2">
                    ...
                    {['#4F46E5', '#f788a5', '#094229', '#E1AD01'].map(color => (
                        <button
                            key={color}
                ...
                <div className="flex gap-2 items-center">
                    <button
                        ...
                        className={`btn btn-sm cursor-pointer shadow-[0_2px_4px_rgba(0,0,0,0.05)] transition-colors tooltip tooltip-top ${viewAngle === 'isometric' ? 'bg-[#4F46E5] text-white border-transparent hover:bg-indigo-700' : 'bg-white border-[#E5E7EB] text-[#374151] hover:bg-gray-50'}`}
                        data-tip="Isometric View"
                        style={{ height: '36px', width: '36px', padding: 0, borderRadius: '12px' }}
                    >
                    ...
                    <button
                        ...
                        className={`btn btn-sm cursor-pointer shadow-[0_2px_4px_rgba(0,0,0,0.05)] transition-colors tooltip tooltip-top ${viewAngle === 'flat' ? 'bg-[#4F46E5] text-white border-transparent hover:bg-indigo-700' : 'bg-white border-[#E5E7EB] text-[#374151] hover:bg-gray-50'}`}
                        data-tip="Flat View"
                        style={{ height: '36px', width: '36px', padding: 0, borderRadius: '12px' }}
                    >
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <button
                        ...
                        style={{
                            ...
                            padding: 0,
                            borderRadius: '12px',
                            background: '#4F46E5', /* Sleek generic primary color */
